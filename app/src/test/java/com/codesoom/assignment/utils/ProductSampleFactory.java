...
public class ProductSampleFactory {
    ...
    public static ProductDto.RegisterParam createRequestParam() {
        ProductDto.RegisterParam request = new ProductDto.RegisterParam();
    ...
    public static ProductDto.RegisterParam createRequestParamWith(FieldName fieldName, ValueType valueType) {
        final ProductDto.RegisterParam request = new ProductDto.RegisterParam();
        String testValue;
    ...
    public static Product.ProductBuilder createProductParamWith(FieldName fieldName, ValueType valueType) {
    ...
    public static ProductCommand.Update of(Long id, Product product) {
    ...
    public static Integer randomPrice() {
        return (int) (Math.ceil((Math.random() * 10000 + 10000) / 1000) * 1000);
    }
