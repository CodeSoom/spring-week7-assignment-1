...
public class TestHelper {
    ...
    public static final SessionRequestData IS_NOT_EXISTS_USER_DATA = SessionRequestData.builder()
            .email(INVALID_EMAIL)
            .password(AUTH_PASSWORD).build();

    public static final SessionRequestData INVALID_PASSWORD_USER_DATA = SessionRequestData.builder()
            .email(AUTH_EMAIL)
            .password(INVALID_PASSWORD)
            .build();

    public static final SessionRequestData AUTH_USER_DATA = SessionRequestData.builder()
            .email(AUTH_EMAIL)
    ...
    public static SessionRequestData AUTH_USER_LOGIN_DATA = SessionRequestData.builder()
            .email(AUTH_EMAIL)
            .password(AUTH_PASSWORD)
            .build();

    public static SessionRequestData EMAIL_NULL_LOGIN_USER_DATA = SessionRequestData.builder()
            .password(AUTH_PASSWORD)
            .build();

    public static SessionRequestData PASSWORD_NULL_LOGIN_USER_DATA = SessionRequestData.builder()
            .email(AUTH_EMAIL)
            .build();

    public static SessionRequestData EMPTY_LOGIN_USER_DATA = SessionRequestData.builder()
            .email("")
            .password("")
            .build();

    public static SessionRequestData EMAIL_IS_SHORT_LOGIN_USER_DATA = SessionRequestData.builder()
            .email("aa")
            .password(AUTH_PASSWORD)
            .build();

    public static SessionRequestData PASSWORD_IS_TOO_SHORT_LOGIN_USER_DATA = SessionRequestData.builder()
            .email(AUTH_EMAIL)
            .password("111")
            .build();

    public static SessionRequestData PASSWORD_IS_TOO_LONG_LOGIN_USER_DATA = SessionRequestData.builder()
            .email(AUTH_EMAIL)
