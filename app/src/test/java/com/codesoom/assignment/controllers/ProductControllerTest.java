...
class ProductControllerTest {
    ...
    class DescribeDetail {
        ...
        @Nested
        @DisplayName("찾을 수 있는 상품에 대한 요청을 받으면")
        ...
        @Nested
        @DisplayName("찾을 수 없는 상품에 대한 요청을 받으면")
    ...
    class DescribeCrete {
        ...
        void tokenSetUp() {
            ...
            given(authenticationService.parseToken(token))
                    .willReturn(authorizedUserId);
        }
        ...
        class ContextWithUnauthorizedUser {
            ...
            void setUp() {
                ...
                given(authenticationService.parseToken(unauthorizedToken))
    ...
    class DescribeUpdate {
        ...
        @Nested
        @DisplayName("찾을 수 없는 상품에 대한 수정 요청을 받으면")
        class ContextWithNotExistedProduct {
    ...
    class DescribeDestroy {
        ...
        @Nested
        @DisplayName("찾을 수 있는 상품에 대한 삭제 요청을 받으면")
        class ContextWithExistedProduct {
        ...
        @Nested
        @DisplayName("찾을 수 없는 상품에 대한 삭제 요청을 받으면")
        class ContextWithNotExistedProduct {
